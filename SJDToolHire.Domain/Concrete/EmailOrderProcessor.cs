...
namespace SJDToolHire.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string FileLocation = @"C:\Users\Spencer\Dev\dotnet\asp-mvc\SportsStore\test-data\order-emails";
    }
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            ...
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Tool.Rate * line.Quantity;
                    body.AppendFormat("{0} x {1} (subtotal: {2:c}", line.Quantity, line.Tool.Name, subtotal);
                }
